...
from app.api.routes import relatorios, matriz_planejamento, dashboard, filtros, projeto_routes, secao_routes, status_projeto_routes, alocacao_routes
...
v1_router.include_router(alocacao_routes.router, prefix="/alocacoes", tags=["Alocações"])
